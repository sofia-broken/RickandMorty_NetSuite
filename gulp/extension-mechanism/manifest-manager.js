...
,	handleOverrides: function handleOverrides(){
		...
		var theme_folder = path.resolve(configs.folders.theme_path)
		,	base_path = path.resolve(configs.folders.source.source_path)
		,	extensions_folder = path.resolve(configs.folders.source.extras_path)
		;
