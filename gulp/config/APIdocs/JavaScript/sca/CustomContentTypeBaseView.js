...
class CustomContentTypeBaseView extends View {
	...
	/**
	 * Validate if the context that a view receives is enough for the view to work returning true or false otherwise.

		* @param {any} context_data An object with the contexts found
		* @return {Boolean} if true it means everything is fine for this view, otherwise the view will not be initialised. Error appears in SMT UI if there was a problem with the data.
		*/
